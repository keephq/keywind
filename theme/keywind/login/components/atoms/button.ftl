<#macro kw color="" component="button" size="" rest...>
  <#switch color>
    <#case "primary">
      <#assign colorClass="bg-primary-300 text-white focus:ring-primary-600 hover:bg-primary-700">
      <#break>
    <#case "secondary">
      ...
      <#break>
    <#default>
      <#assign colorClass="bg-primary-200 text-white focus:ring-primary-600 hover:bg-primary-700">
  </#switch>
